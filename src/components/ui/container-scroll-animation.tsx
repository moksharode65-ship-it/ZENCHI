...
export const ContainerScroll = ({
  ...
  return (
    <div className="relative flex h-[60rem] items-center justify-center p-2 md:h-[80rem] md:p-20" ref={containerRef}>
      <div
        className="relative w-full rounded-3xl border border-[#243053] bg-[#070b17] py-10 md:py-40"
        style={{
          perspective: "1000px",
        }}
      >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-[30rem] w-full max-w-5xl rounded-[30px] border-4 border-[#364474] bg-[#10162a] p-2 shadow-2xl md:h-[40rem] md:p-6"
    >
