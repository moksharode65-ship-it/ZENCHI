...
export function ZoomParallax({ images }: ZoomParallaxProps) {
  ...
  return (
    <div ref={container} className="relative h-[300vh]">
      <div className="sticky top-0 h-screen overflow-hidden rounded-3xl border border-[#243053] bg-[#070b17]">
        {images.map(({ src, alt }, index) => {
          ...
          return (
            ...
            >
              <div className="relative h-[25vh] w-[25vw] overflow-hidden rounded-2xl border border-[#2f3b62] shadow-2xl">
